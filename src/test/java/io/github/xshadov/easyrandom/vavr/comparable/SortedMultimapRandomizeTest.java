...
public class SortedMultimapRandomizeTest extends VavrGenerationTests {
	@Value
	private static class Person {
		private SortedMultimap<String, Integer> integerMultimap;
		private SortedMultimap<String, String> stringMultimap;
	}
