...
public class LinkedHashMapRandomizeTest extends VavrGenerationTests {
	@Value
	private static class Person {
		private LinkedHashMap<String, Integer> simple;
		private LinkedHashMap<String, List<String>> listMap;
		private LinkedHashMap<String, Set<String>> setMap;
		private LinkedHashMap<String, LinkedHashMap<String, String>> nestedMap;
	}
