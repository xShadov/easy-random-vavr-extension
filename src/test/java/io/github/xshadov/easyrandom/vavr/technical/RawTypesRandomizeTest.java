...
public class RawTypesRandomizeTest extends VavrGenerationTests {
	...
	private static class NestedTypes {
		...
		private HashMap<String, HashMap> hashMap;
		private SortedMap<String, SortedMap> sortedMap;
		private TreeMap<String, TreeMap> treeMap;
		private LinkedHashMap<String, LinkedHashMap> linkedHashMap;
		private Multimap<String, Multimap> multimap;
		private SortedMultimap<String, SortedMultimap> sortedMultimap;
		private TreeMultimap<String, TreeMultimap> treeMultimap;
		private HashMultimap<String, HashMultimap> hashMultimap;
		private LinkedHashMultimap<String, LinkedHashMultimap> linkedHashMultimap;
