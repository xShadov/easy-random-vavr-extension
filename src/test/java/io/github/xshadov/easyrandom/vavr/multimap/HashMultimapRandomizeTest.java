...
public class HashMultimapRandomizeTest extends VavrGenerationTests {
	@Value
	private static class Person {
		private HashMultimap<String, Integer> integerMultimap;
		private HashMultimap<String, String> stringMultimap;
	}
